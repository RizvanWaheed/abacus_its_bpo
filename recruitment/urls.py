...
from .views import ApplicantsView, ApplicantSchedulerView, ApplicantOrientationView, ApplicantsScoreView
...
urlpatterns = [
    ...
    path('search_applicant', login_required(ApplicantsView.searchApplicantCnic), name="search_applicant"),
    path('download_applicant', login_required(ApplicantsView.downloadApplicant), name="download_applicant"),
    ...
    path('<str:page>', ApplicantsView.index, name='index'),

    #   path('applications/', )applicant_selected
