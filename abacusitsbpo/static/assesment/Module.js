...
var LoginLocation = '';
var AssesmentModule = angular.module('Assesment', ['ngRoute', 'ngAnimate', 'ngResource', 'ngMessages', 'ui.bootstrap', 'AppFilter', 'AppDirective', 'ui.select', 'angularFileUpload', 'ngSanitize', 'ngCookies', 'treeGrid', 'ui.mask']).run( function run( $http, $cookies ){
    // For CSRF token compatibility with Django
    $http.defaults.headers.post['X-CSRFToken'] = $cookies.get('csrftoken');
});
AssesmentModule.config(['$httpProvider', function($httpProvider) {
