RecruitmentModule.controller('ProfileRecruitmentController', ['$scope', '$location', '$upload', '$filter', 'Svc',
	function($scope,$location,$upload,$filter,Svc){
        ...
        // ng-if="checked"
		$scope.listOfCountries  = countries;
		...
		$scope.listOfReligions = religions;
		$scope.listOfSects = sects;
		...
		$scope.cancelForm = function(){
			...
			$scope.applicant = {
				...
				cnic_expiry_date: new Date(1985, 05, 28),
                department_id: '',
				desiganation_id: '',
				project_id: '',
                address: '',
		...
		$scope.$watch('applicant.current_address', function (newval, oldval) {
			$scope.applicant.address = newval;
		});
		$scope.$watch('applicant.current_city_id', function (newval, oldval) {
			$scope.applicant.city_id = newval;
		});
		$scope.$watch('applicant.current_country_id', function (newval, oldval) {
			$scope.applicant.country_id = newval;
		});
